        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-4">
                                <a href="/admin/destek" class="m-3 btn btn-primary btn-block" style="display: block;">Yeni Talep / Tüm Talepler</a>
                                <a  href="javascript:void(0)" class="m-3 btn btn-danger btn-block" @click="onayla(datas)" style="display: block;">Tamamlandı</a>
                                ...
                                <div class="card-body px-4 pt-5">
                                    ...
                                    <div class="card m-2" v-for="mesaj in datasMesajlar">
                                        <div class="card-body">
                                            ...
                                            Tarih : {{ mesaj.created_at | dateConverter}}
                                        </div>
                                    </div>
                                    <div class="card m-2">
                                        <div class="card-body ">
...
export default {
    ...
    methods: {
        dataGet() {
            axios
                .post("/admin/"+this.pageUrl + "/getDetay",{id:this.detayId})
                .then((response) => {
        ...
        mesajGonder() {
            ...
            axios
                .post("/admin/"+this.pageUrl + "/storeDetay",mesajData)
                .then((response) => {
        ...
        onayla(){
            ...
            axios
                .post("/admin/"+this.pageUrl + "/onaylaDetay",{id:this.detayId})
                .then((response) => {
                    this.$toasted.success(response.data.message)
                    this.mesaj=""
                    this.dataGet();
