        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <multiselect @input="dataGet" :options="bayis" v-model="seciliBayi" track_by="id" :multiple="false" label="firma_adi" placeholder="Bayi Seçiniz"  ></multiselect>
                </div>
            </div>
            <div class="col-md-4">
                                                    ...
                                                    >
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <a
                                                                ...
                                                                :href='"/admin/destek/detay/"+data.id'
                                                            >
                                                                Detay
                                                            </a>
                                                        </td>
