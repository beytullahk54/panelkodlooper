        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="mb-3"  >
                    ...
                    <multiselect v-model="db_firma" :options="firmas"   track-by="firma_adi" :multiple="false" label="db_sirket_unvani"  placeholder="Bayi Seçiniz" ></multiselect>
                </div>
                <div class="mb-3">
               ...
               <div class="form-group">
                   <div class="row ">
                       ...
                       <div class="col-md-8">
                           <multiselect v-model="db_satis_sitesi" :options="dataSatisSitesi" track_by="id" :multiple="false" label="db_adi" placeholder="Satış Sitenizi Seçiniz"  ></multiselect>
                       </div>
                   </div>
               </div>
               ...
               <div class="form-group">
                   <div class="row ">
                       ...
                       <div class="col-md-8">
                           <multiselect v-model="db_site_odeme_turu" :options="dataOdemeTuru" track_by="id" :multiple="false" label="db_adi" placeholder="Site Ödeme Türünü Seçiniz"  ></multiselect>
                       </div>
                   </div>
               </div>
...
export default {
    ...
    data() {
        return {
            ...
            data:{
                ...
                db_katilimci_durum:[{"id":1,"db_adi":"Onay bekliyor"}],
                db_adres:this.$developer?"Vatan Mah. 4235 Sok. A blok daire 2 Yazlık Serdivan Sakarya":"",
                sertifikas:[]
            },
            katilimciDosya:[],
            katilimciDosya2:[],
            katilimciDurum:[{"id":1,"db_adi":"Onay bekliyor"}],
            katilimciDurums:[
    ...
    methods: {
        firmaGet(){
            axios
                .post("/admin/katilimci/getFirma")
                .then((response) => {
                    console.log(response.data);
                    this.firmas = response.data.data;
                    this.data.db_firma = response.data.data;
        ...
        dataStore() {
            ...
            this.data.db_firma_id = this.db_firma?.id
            ...
            this.data.db_satis_sitesi = JSON.stringify(this.db_satis_sitesi )
            this.data.db_site_odeme_turu = JSON.stringify(this.db_site_odeme_turu )
            ...
            axios
                .post("/admin/katilimci/create" , this.data)
                .then((response) => {
