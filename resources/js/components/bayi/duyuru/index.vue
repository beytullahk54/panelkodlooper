                                                    ...
                                                    >
                                                        ...
                                                        <td>
                                                            <span class="btn btn-success btn-block" v-if=" data.db_tip=='ozel'">
                                                                {{ data.db_tip=="ozel"?"Size Özel":"" }}<br>
                                                                {{  data.db_hedef_firma_id?data.db_hedef_firma_id.firma_adi:"" }}
                                                            </span >
...
export default {
    ...
    props: { pageTitle: String, pageUrl: String,yeni:String ,search:String },
    mounted() {
        this.dataGet();
    },
    methods: {
        dataGet(page = 1) {
            axios
                .post("/bayi/"+this.pageUrl + "/get?page=" + page)
                .then((response) => {
